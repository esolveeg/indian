                ...
                <div class='flex-shrink-0 px-4 py-5 border-t border-gray-200 sm:px-6' dir='ltr'>
                  <div class='flex justify-between space-x-3'>
                    ...
                    <button
                      ...
                      type='button'
                      @click='updateMarker(); this.setCurrentAddressAction(this.newAddress); toggleAddressPickerAction(); '>
                      {{ $t('Save') }}
                    </button>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    updateMarker(place) {
      ...
      this.newAddress.latitude = this.marker.lat
      this.newAddress.longitude = this.marker.lng
      this.setNewAddressAction(this.newAddress)
    },
  },
}
